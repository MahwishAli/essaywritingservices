        ...
        <div class="flex flex-col space-y-4 my-2 md:my-0 lg:flex-row lg:mx-4">
            ...
            <div class="panel w-full sm:w-[70%] lg:w-[35%] xl:w-[30%] mx-auto ">
                <form id="registration-form" action="{{ route('register') }}" method="POST"
                    class="border-4 card bg-white border-[#6ec1e4] shadow-md rounded-lg px-4 pt-2 pb-6 flex flex-col md:ml-auto w-full space-y-2  ">
                    ...
                    <div class="mb-2">
                        <input type="text" id="phone"  class="form-input px-10 @error('phone') error-field @enderror" placeholder="" value="{{ old('phone','') }}"/>
